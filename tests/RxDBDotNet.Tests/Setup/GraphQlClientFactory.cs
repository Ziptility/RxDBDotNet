...
public static class GraphQlClientFactory
{
    ...
    public static async Task GenerateLiveDocsGraphQLClientAsync(this HttpClient httpClient)
    {
        ...
        var csharpCode = generator.GenerateFullClientCSharpFile(schema, "RxDBDotNet.Tests.Setup");
        ...
        await File.WriteAllTextAsync("../../../Setup/LiveDocsGraphQLClient.cs", modifiedCsharpCode);
    }
}
